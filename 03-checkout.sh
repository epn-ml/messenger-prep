...
grep SCI MESS_MAGRDR_DS.CAT | egrep '201[1-5]' | sed -e s/MOI//g -e s/OB[1-5]//g | grep '('  | sed 's/1Apr2005/01Apr2005/g' | sed 's/9Aug2005/09Apr2005/g' | sed 's/29Feb2013(060)/28Feb2013(059)/g' | awk '{ print $1 $2 $3 $4 $5 $6 $7 $8}'
